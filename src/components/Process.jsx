...
const ProcessSection = memo(forwardRef(({ isProcessInView }, ref) => (
    <section id='process' ref={ref} className={`max-w-screen w-full h-full md:pl-24 pr-10 md:pr-20 ${isProcessInView ? 'bg-[#080808] text-white' : 'bg-transparent opacity-100 text-black'} backdrop-blur-sm py-16 text-white rounded-3xl bg-image-sponge transition-all duration-300`}>
        <div>
