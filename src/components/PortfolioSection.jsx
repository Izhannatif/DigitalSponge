...
const PortfolioSection = () => {
    ...
    const images = {
        ...
        Illustrations:[
            ...
            { type: 'image', src: '../assets/Illustrations/2.png' },
            { type: 'image', src: '../assets/Illustrations/3.png' },
            { type: 'image', src: '../assets/Illustrations/4.png' },
            { type: 'image', src: '../assets/Illustrations/5.png' },
            { type: 'image', src: '../assets/Illustrations/6.png' },
            { type: 'image', src: '../assets/Illustrations/7.png' },
            { type: 'image', src: '../assets/Illustrations/8.png' },
            { type: 'image', src: '../assets/Illustrations/9.png' },
            { type: 'image', src: '../assets/Illustrations/10.png' },
            { type: 'image', src: '../assets/Illustrations/11.png' },
            { type: 'image', src: '../assets/Illustrations/12.png' },
            { type: 'image', src: '../assets/Illustrations/13.png' },
            { type: 'image', src: '../assets/Illustrations/14.png' },
        ],
        Logos:[
